...
public class MicroarraystudyAdaptorImpl extends BaseAdaptor implements MicroarraystudyAdaptor{
	...
	public Microarraystudy[] fetchAllMicroarraystudies() {
		return fetchAllMicroarraystudies(true);
	}
	...
	public Microarraystudy[] fetchAllMicroarraystudies(boolean withChildren) {
		...
		try{
			...
			query.append("SELECT ").append("microarraystudy.microarraystudy_id, " +
					...
					.append(" LEFT JOIN ")
					.append("sample_on_chip ON microarraystudy.microarraystudy_id = sample_on_chip.sample_on_chip_microarraystudy_id")
					.append(" LEFT JOIN ")
					.append("tissue_sample ON sample_on_chip.sample_on_chip_tissue_sample_id = tissue_sample.tissue_sample_id")
					.append(" ORDER BY microarraystudy_id ASC");
	...
	public Microarraystudy[] fetchMicroarraystudiesForProject(int projectId) {
		int[] p = {projectId};
		return fetchMicroarraystudiesForProject(p, true);
	}
	
	@Override
	public Microarraystudy[] fetchMicroarraystudiesForProject(int projectId, boolean withChildren) {
		int[] p = {projectId};
		return fetchMicroarraystudiesForProject(p, withChildren);
	}
	
	@Override
	public Microarraystudy[] fetchMicroarraystudiesForProject(int[] projectIds){
		return fetchMicroarraystudiesForProject(projectIds, true);
	}
	...
	public Microarraystudy[] fetchMicroarraystudiesForProject(int[] projectIds, boolean withChrildren) {
		...
		try{
			...
			query.append("SELECT ").append("microarraystudy.microarraystudy_id, " +
					...
					.append("sample_on_chip ON microarraystudy.microarraystudy_id = sample_on_chip.sample_on_chip_microarraystudy_id")
					.append(" LEFT JOIN ")
					.append("microarraystudy_in_project ON microarraystudy.microarraystudy_id = microarraystudy_in_project.microarraystudy_id")
					.append(" WHERE ");
			...
			query.append(" ORDER BY microarraystudy.microarraystudy_id");
